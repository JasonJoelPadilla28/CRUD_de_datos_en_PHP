       ...
       <?php
           ...
           $UpdateSQL= "delete from productos where id=$id";
            ...
            if($conexion->query($UpdateSQL)===TRUE){
                  ...
                  <p>Los datos han sido eliminados, ya no aparecera la información de '.$descripcion.' en la lista.</p>
                  <hr>
                  ...
                  <p>Ha ocurrido un error en los datos enviados y estos no fueron actualizados.</p>
                  <hr>
                  <p class="mb-0">
