...
<div class="container">
      <div class="row mt-5">
       <?php
           ...
           $InsertSQL="insert into productos(descripcion, cantidad, precio, fechaelab, fechavenc) Values('$descripcion','$cantidad',
           '$precio','$fechaelab','$fechavenc')";
           
            if($conexion->query($InsertSQL)===TRUE){
                  echo'
                  <div class="alert alert-success w-100" role="alert">
                  <h4 class="alert-heading">información almacenada!</h4>
                  <p>Los datos han sido almacenados, puede consultar la información de '.$descripcion.''.$cantidad.'
                  '.$precio.''.$fechaelab.''.$fechavenc.'en la lista.</p>
                  <hr>
